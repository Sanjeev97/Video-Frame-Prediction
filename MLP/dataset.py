...
class MovingMNISTDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # For MLP, we need to flatten the images
        input_frames_flat = input_frames.view(self.seq_length, -1)
        target_frames_flat = target_frames.view(self.pred_length, -1)
        
        return input_frames_flat, target_frames_flat, input_frames, target_frames
...
def visualize_dataset(dataset, num_samples=3):
    ...
    for i in range(num_samples):
        ...
        _, _, input_frames, target_frames = dataset[idx]
